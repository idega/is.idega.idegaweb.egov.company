...
public class IcelandicOnlineBankingSecondaryCollectionClaimsServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsService {
    ...
    public is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap getIcelandicOnlineBankingSecondaryCollectionClaimsSoap() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap getIcelandicOnlineBankingSecondaryCollectionClaimsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub _stub = new is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub _stub = new is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub(new java.net.URL(IcelandicOnlineBankingSecondaryCollectionClaimsSoap_address), this);
                _stub.setPortName(getIcelandicOnlineBankingSecondaryCollectionClaimsSoapWSDDServiceName());
                return _stub;
            }
        }
