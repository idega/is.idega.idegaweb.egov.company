...
public class ClaimOperationResult  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.BatchStatus status;

    /* List of claims whose operation was a success. */
    private is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult[] success;

    /* List of claims with errors. */
    private is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError[] errors;
    ...
    public ClaimOperationResult(
           java.lang.String ID,
           is.idega.idegaweb.egov.company.banking.ws.claims.BatchStatus status,
           is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult[] success,
           is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError[] errors) {
           this.ID = ID;
           this.status = status;
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.BatchStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(is.idega.idegaweb.egov.company.banking.ws.claims.BatchStatus status) {
        this.status = status;
    }
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult[] getSuccess() {
        return success;
    }
     ...
     */
    public void setSuccess(is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult[] success) {
        this.success = success;
    }

    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult getSuccess(int i) {
        return this.success[i];
    }

    public void setSuccess(int i, is.idega.idegaweb.egov.company.banking.ws.claims.ClaimResult _value) {
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError[] getErrors() {
        return errors;
    }
     ...
     */
    public void setErrors(is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError[] errors) {
        this.errors = errors;
    }

    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, is.idega.idegaweb.egov.company.banking.ws.claims.ClaimError _value) {
