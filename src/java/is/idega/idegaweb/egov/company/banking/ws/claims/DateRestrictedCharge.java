...
public class DateRestrictedCharge  implements java.io.Serializable {
    private is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase first;

    private is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase second;

    private is.idega.idegaweb.egov.company.banking.ws.claims.ReferenceDate referenceDate;  // attribute
     ...
     * @return first
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase getFirst() {
        return first;
    }
     ...
     * @param first
     */
    public void setFirst(is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase first) {
        this.first = first;
    }
     ...
     * @return second
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase getSecond() {
        return second;
    }
     ...
     * @param second
     */
    public void setSecond(is.idega.idegaweb.egov.company.banking.ws.claims.DiscountOrDefaultChargeBase second) {
        this.second = second;
    }
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.ReferenceDate getReferenceDate() {
        return referenceDate;
    }
     ...
     * @param referenceDate
     */
    public void setReferenceDate(is.idega.idegaweb.egov.company.banking.ws.claims.ReferenceDate referenceDate) {
        this.referenceDate = referenceDate;
    }
