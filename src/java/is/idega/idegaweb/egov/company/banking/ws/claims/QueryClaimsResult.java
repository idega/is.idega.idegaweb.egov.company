...
public class QueryClaimsResult  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo[] claims;
    ...
    public QueryClaimsResult(
           ...
           is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo[] claims) {
     ...
     * @return claims
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo[] getClaims() {
        return claims;
    }
     ...
     * @param claims
     */
    public void setClaims(is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo[] claims) {
        this.claims = claims;
    }

    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo getClaims(int i) {
        return this.claims[i];
    }

    public void setClaims(int i, is.idega.idegaweb.egov.company.banking.ws.claims.ClaimInfo _value) {
