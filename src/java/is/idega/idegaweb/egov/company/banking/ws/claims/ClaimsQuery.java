...
public class ClaimsQuery  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.ClaimsQueryDateSpan period;
    ...
    public ClaimsQuery(
           ...
           is.idega.idegaweb.egov.company.banking.ws.claims.ClaimsQueryDateSpan period,
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.ClaimsQueryDateSpan getPeriod() {
        return period;
    }
     ...
     */
    public void setPeriod(is.idega.idegaweb.egov.company.banking.ws.claims.ClaimsQueryDateSpan period) {
        this.period = period;
    }
