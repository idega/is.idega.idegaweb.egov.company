...
public class CommunicationPostalMail  extends is.idega.idegaweb.egov.company.banking.ws.payments.Receipt  implements java.io.Serializable {
    /* The address for the receiver of the receipt */
    private is.idega.idegaweb.egov.company.banking.ws.common.Address receiverAddress;
    ...
    public CommunicationPostalMail(
           ...
           is.idega.idegaweb.egov.company.banking.ws.common.Address receiverAddress,
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.common.Address getReceiverAddress() {
     ...
     */
    public void setReceiverAddress(is.idega.idegaweb.egov.company.banking.ws.common.Address receiverAddress) {
        this.receiverAddress = receiverAddress;
    }
