...
public class PaymentResultDetails  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.payments.PaymentSlipInfo paymentSlip;
    ...
    public PaymentResultDetails(
           ...
           is.idega.idegaweb.egov.company.banking.ws.payments.PaymentSlipInfo paymentSlip,
     ...
     * Includes information such as how much was paid in interests and charges
     */
    public is.idega.idegaweb.egov.company.banking.ws.payments.PaymentSlipInfo getPaymentSlip() {
        return paymentSlip;
    }
     ...
     * Includes information such as how much was paid in interests and charges
     */
    public void setPaymentSlip(is.idega.idegaweb.egov.company.banking.ws.payments.PaymentSlipInfo paymentSlip) {
        this.paymentSlip = paymentSlip;
    }
