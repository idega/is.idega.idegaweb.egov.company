...
public class IcelandicOnlineBankingSecondaryCollectionClaimsSoapProxy implements is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap {
  private String _endpoint = null;
  private is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap icelandicOnlineBankingSecondaryCollectionClaimsSoap = null;
  ...
  private void _initIcelandicOnlineBankingSecondaryCollectionClaimsSoapProxy() {
    try {
      icelandicOnlineBankingSecondaryCollectionClaimsSoap = (new is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsServiceLocator()).getIcelandicOnlineBankingSecondaryCollectionClaimsSoap();
  ...
  public is.idega.idegaweb.egov.company.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap getIcelandicOnlineBankingSecondaryCollectionClaimsSoap() {
    if (icelandicOnlineBankingSecondaryCollectionClaimsSoap == null)
      _initIcelandicOnlineBankingSecondaryCollectionClaimsSoapProxy();
