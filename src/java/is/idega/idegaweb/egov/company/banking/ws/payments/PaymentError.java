...
public class PaymentError  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.payments.PaymentIn payment;

    /* Information about the error */
    private is.idega.idegaweb.egov.company.banking.ws.common.Error error;

    public PaymentError() {
    }

    public PaymentError(
           is.idega.idegaweb.egov.company.banking.ws.payments.PaymentIn payment,
           is.idega.idegaweb.egov.company.banking.ws.common.Error error) {
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.payments.PaymentIn getPayment() {
        return payment;
    }
     ...
     */
    public void setPayment(is.idega.idegaweb.egov.company.banking.ws.payments.PaymentIn payment) {
        this.payment = payment;
    }
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.common.Error getError() {
        return error;
    }
     ...
     */
    public void setError(is.idega.idegaweb.egov.company.banking.ws.common.Error error) {
        this.error = error;
    }
