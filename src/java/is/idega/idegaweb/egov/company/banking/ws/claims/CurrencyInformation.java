...
public class CurrencyInformation  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationReferenceRate referenceRate;
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationPaymentRate paymentRate;

    public CurrencyInformation() {
    }

    public CurrencyInformation(
           is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationReferenceRate referenceRate,
           java.lang.String currency,
           is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationPaymentRate paymentRate) {
     ...
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationReferenceRate getReferenceRate() {
     ...
     */
    public void setReferenceRate(is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationReferenceRate referenceRate) {
        this.referenceRate = referenceRate;
    }
     ...
     * of an IK forex claim.
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationPaymentRate getPaymentRate() {
        return paymentRate;
    }
     ...
     * of an IK forex claim.
     */
    public void setPaymentRate(is.idega.idegaweb.egov.company.banking.ws.claims.CurrencyInformationPaymentRate paymentRate) {
        this.paymentRate = paymentRate;
    }
