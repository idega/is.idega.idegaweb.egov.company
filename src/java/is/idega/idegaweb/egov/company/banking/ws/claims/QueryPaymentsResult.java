...
public class QueryPaymentsResult  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.company.banking.ws.claims.Payment[] payments;
    ...
    public QueryPaymentsResult(
           ...
           is.idega.idegaweb.egov.company.banking.ws.claims.Payment[] payments) {
     ...
     * @return payments
     */
    public is.idega.idegaweb.egov.company.banking.ws.claims.Payment[] getPayments() {
        return payments;
    }
     ...
     * @param payments
     */
    public void setPayments(is.idega.idegaweb.egov.company.banking.ws.claims.Payment[] payments) {
        this.payments = payments;
    }

    public is.idega.idegaweb.egov.company.banking.ws.claims.Payment getPayments(int i) {
        return this.payments[i];
    }

    public void setPayments(int i, is.idega.idegaweb.egov.company.banking.ws.claims.Payment _value) {
