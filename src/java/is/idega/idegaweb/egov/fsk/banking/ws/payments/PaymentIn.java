...
public class PaymentIn  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentSlip paymentSlip;
    ...
    public PaymentIn(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentSlip paymentSlip,
     ...
     * @return paymentSlip
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentSlip getPaymentSlip() {
        return paymentSlip;
    }
     ...
     * @param paymentSlip
     */
    public void setPaymentSlip(is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentSlip paymentSlip) {
        this.paymentSlip = paymentSlip;
    }
