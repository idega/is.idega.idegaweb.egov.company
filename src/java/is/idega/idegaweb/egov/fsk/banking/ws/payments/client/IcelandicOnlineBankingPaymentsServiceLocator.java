...
public class IcelandicOnlineBankingPaymentsServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsService {
    ...
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoap getIcelandicOnlineBankingPaymentsSoap() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoap getIcelandicOnlineBankingPaymentsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoapStub _stub = new is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoapStub _stub = new is.idega.idegaweb.egov.fsk.banking.ws.payments.client.IcelandicOnlineBankingPaymentsSoapStub(new java.net.URL(IcelandicOnlineBankingPaymentsSoap_address), this);
                _stub.setPortName(getIcelandicOnlineBankingPaymentsSoapWSDDServiceName());
                return _stub;
            }
        }
