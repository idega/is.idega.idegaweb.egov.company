...
public class Claim  implements java.io.Serializable {
     ...
     * to payer. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.NoticeAndPaymentFee noticeAndPaymentFee;

    /* Default charge that claims incur when they default, either
     * a percentage or fixed amount. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.DateRestrictedCharge defaultCharge;
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterest defaultInterest;

    /* For claims which are linked to a foreign currency. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.CurrencyInformation currencyInformation;
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.DiscountCharge discount;
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.BillPresentmentSystem billPresentmentSystem;

    /* Information that is used when printing a claim, if it is to
     * be printed by the bank. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.Printing printing;
    ...
    public Claim(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.claims.NoticeAndPaymentFee noticeAndPaymentFee,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.DateRestrictedCharge defaultCharge,
           java.math.BigDecimal otherCosts,
           java.math.BigDecimal otherDefaultCosts,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterest defaultInterest,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.CurrencyInformation currencyInformation,
           boolean permitOutOfSequencePayment,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.DiscountCharge discount,
           boolean isPartialPaymentAllowed,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.BillPresentmentSystem billPresentmentSystem,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.Printing printing) {
           this.key = key;
     ...
     * to payer.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.NoticeAndPaymentFee getNoticeAndPaymentFee() {
     ...
     * to payer.
     */
    public void setNoticeAndPaymentFee(is.idega.idegaweb.egov.fsk.banking.ws.claims.NoticeAndPaymentFee noticeAndPaymentFee) {
        this.noticeAndPaymentFee = noticeAndPaymentFee;
    }
     ...
     * a percentage or fixed amount.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.DateRestrictedCharge getDefaultCharge() {
     ...
     * a percentage or fixed amount.
     */
    public void setDefaultCharge(is.idega.idegaweb.egov.fsk.banking.ws.claims.DateRestrictedCharge defaultCharge) {
        this.defaultCharge = defaultCharge;
    }
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterest getDefaultInterest() {
     ...
     */
    public void setDefaultInterest(is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterest defaultInterest) {
        this.defaultInterest = defaultInterest;
    }
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.CurrencyInformation getCurrencyInformation() {
     ...
     */
    public void setCurrencyInformation(is.idega.idegaweb.egov.fsk.banking.ws.claims.CurrencyInformation currencyInformation) {
        this.currencyInformation = currencyInformation;
    }
     ...
     * payment if made before a fixed date.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.DiscountCharge getDiscount() {
        return discount;
    }
     ...
     * payment if made before a fixed date.
     */
    public void setDiscount(is.idega.idegaweb.egov.fsk.banking.ws.claims.DiscountCharge discount) {
        this.discount = discount;
    }
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.BillPresentmentSystem getBillPresentmentSystem() {
     ...
     */
    public void setBillPresentmentSystem(is.idega.idegaweb.egov.fsk.banking.ws.claims.BillPresentmentSystem billPresentmentSystem) {
        this.billPresentmentSystem = billPresentmentSystem;
    }
     ...
     * be printed by the bank.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.Printing getPrinting() {
        return printing;
    }
     ...
     * be printed by the bank.
     */
    public void setPrinting(is.idega.idegaweb.egov.fsk.banking.ws.claims.Printing printing) {
        this.printing = printing;
    }
