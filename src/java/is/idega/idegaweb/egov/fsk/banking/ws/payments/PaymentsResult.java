...
public class PaymentsResult  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.BatchStatus status;

    /* Lists the payments that where executed with success. */
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails[] success;

    /* The payments that resulted in errors. */
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError[] errors;
    ...
    public PaymentsResult(
           java.lang.String ID,
           is.idega.idegaweb.egov.fsk.banking.ws.payments.BatchStatus status,
           is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails[] success,
           is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError[] errors,
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.BatchStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(is.idega.idegaweb.egov.fsk.banking.ws.payments.BatchStatus status) {
        this.status = status;
    }
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails[] getSuccess() {
        return success;
    }
     ...
     */
    public void setSuccess(is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails[] success) {
        this.success = success;
    }

    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails getSuccess(int i) {
        return this.success[i];
    }

    public void setSuccess(int i, is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentResultDetails _value) {
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError[] getErrors() {
        return errors;
    }
     ...
     */
    public void setErrors(is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError[] errors) {
        this.errors = errors;
    }

    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentError _value) {
