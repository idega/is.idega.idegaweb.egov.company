...
public class IcelandicOnlineBankingClaimsSoapProxy implements is.idega.idegaweb.egov.fsk.banking.ws.claims.client.IcelandicOnlineBankingClaimsSoap {
  private String _endpoint = null;
  private is.idega.idegaweb.egov.fsk.banking.ws.claims.client.IcelandicOnlineBankingClaimsSoap icelandicOnlineBankingClaimsSoap = null;
  ...
  private void _initIcelandicOnlineBankingClaimsSoapProxy() {
    try {
      icelandicOnlineBankingClaimsSoap = (new is.idega.idegaweb.egov.fsk.banking.ws.claims.client.IcelandicOnlineBankingClaimsServiceLocator()).getIcelandicOnlineBankingClaimsSoap();
  ...
  public is.idega.idegaweb.egov.fsk.banking.ws.claims.client.IcelandicOnlineBankingClaimsSoap getIcelandicOnlineBankingClaimsSoap() {
    if (icelandicOnlineBankingClaimsSoap == null)
      _initIcelandicOnlineBankingClaimsSoapProxy();
