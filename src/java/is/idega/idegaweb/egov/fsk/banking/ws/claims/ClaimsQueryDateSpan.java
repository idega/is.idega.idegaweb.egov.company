...
public class ClaimsQueryDateSpan  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.DateSpanReferenceDate dateSpanReferenceDate;  // attribute
    ...
    public ClaimsQueryDateSpan(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.claims.DateSpanReferenceDate dateSpanReferenceDate) {
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.DateSpanReferenceDate getDateSpanReferenceDate() {
        return dateSpanReferenceDate;
    }
     ...
     */
    public void setDateSpanReferenceDate(is.idega.idegaweb.egov.fsk.banking.ws.claims.DateSpanReferenceDate dateSpanReferenceDate) {
        this.dateSpanReferenceDate = dateSpanReferenceDate;
    }
