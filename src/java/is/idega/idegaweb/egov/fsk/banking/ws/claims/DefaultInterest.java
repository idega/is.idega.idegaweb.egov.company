...
public class DefaultInterest  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterestRule rule;
    ...
    public DefaultInterest(
           is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterestRule rule,
     ...
     * the reference date and if so, how it should be calculated.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterestRule getRule() {
        return rule;
    }
     ...
     * the reference date and if so, how it should be calculated.
     */
    public void setRule(is.idega.idegaweb.egov.fsk.banking.ws.claims.DefaultInterestRule rule) {
        this.rule = rule;
    }
