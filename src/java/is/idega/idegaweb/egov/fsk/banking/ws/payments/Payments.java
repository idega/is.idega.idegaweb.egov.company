...
public class Payments  implements java.io.Serializable {
    ...
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentIn getIn(int i) {
        return this.in[i];
    }

    public void setIn(int i, is.idega.idegaweb.egov.fsk.banking.ws.payments.PaymentIn _value) {
        this.in[i] = _value;
    }
