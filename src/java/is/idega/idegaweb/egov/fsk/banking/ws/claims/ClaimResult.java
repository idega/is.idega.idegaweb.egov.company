...
public class ClaimResult  implements java.io.Serializable {
     ...
     * printing. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.PrintInformation print;
    ...
    public ClaimResult(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.claims.PrintInformation print) {
           this.key = key;
           this.print = print;
    }
     ...
     * printing.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.PrintInformation getPrint() {
        return print;
    }
     ...
     * printing.
     */
    public void setPrint(is.idega.idegaweb.egov.fsk.banking.ws.claims.PrintInformation print) {
        this.print = print;
    }
