...
public class IcelandicOnlineBankingStatementsServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsService {
    ...
    public is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoap getIcelandicOnlineBankingStatementsSoap() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoap getIcelandicOnlineBankingStatementsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoapStub _stub = new is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoapStub _stub = new is.idega.idegaweb.egov.fsk.banking.ws.statements.client.IcelandicOnlineBankingStatementsSoapStub(new java.net.URL(IcelandicOnlineBankingStatementsSoap_address), this);
                _stub.setPortName(getIcelandicOnlineBankingStatementsSoapWSDDServiceName());
                return _stub;
            }
        }
