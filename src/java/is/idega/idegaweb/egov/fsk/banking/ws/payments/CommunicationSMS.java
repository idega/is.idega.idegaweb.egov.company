...
public class CommunicationSMS  extends is.idega.idegaweb.egov.fsk.banking.ws.payments.Receipt  implements java.io.Serializable {
    private is.idega.idegaweb.egov.fsk.banking.ws.common.PhoneNumber phoneNumber;
    ...
    public CommunicationSMS(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.common.PhoneNumber phoneNumber) {
        super(
            language);
     ...
     * @return phoneNumber
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.common.PhoneNumber getPhoneNumber() {
        return phoneNumber;
    }
     ...
     * @param phoneNumber
     */
    public void setPhoneNumber(is.idega.idegaweb.egov.fsk.banking.ws.common.PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;
    }
