...
package is.idega.idegaweb.egov.fsk.banking.ws.statements;
...
public class AccountStatementResponse  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.common.Status status;
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.statements.AccountTransaction[] transactions;
    ...
    public AccountStatementResponse(
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.common.Status status,
           ...
           is.idega.idegaweb.egov.fsk.banking.ws.statements.AccountTransaction[] transactions) {
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.common.Status getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(is.idega.idegaweb.egov.fsk.banking.ws.common.Status status) {
        this.status = status;
    }
     ...
     * @return transactions
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.statements.AccountTransaction[] getTransactions() {
        return transactions;
    }
     ...
     * @param transactions
     */
    public void setTransactions(is.idega.idegaweb.egov.fsk.banking.ws.statements.AccountTransaction[] transactions) {
        this.transactions = transactions;
    }
