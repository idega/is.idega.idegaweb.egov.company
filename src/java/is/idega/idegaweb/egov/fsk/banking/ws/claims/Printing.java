...
public class Printing  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.egov.fsk.banking.ws.common.Address claimantAddress;

    /* Alternate address for payor if address from the National Register
     * should not be used. */
    private is.idega.idegaweb.egov.fsk.banking.ws.common.Address payorAddress;

    /* Details of claim. */
    private is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow[] itemRows;
    ...
    public Printing(
           is.idega.idegaweb.egov.fsk.banking.ws.common.Address claimantAddress,
           is.idega.idegaweb.egov.fsk.banking.ws.common.Address payorAddress,
           is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow[] itemRows,
     ...
     * Register should not be used.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.common.Address getClaimantAddress() {
     ...
     * Register should not be used.
     */
    public void setClaimantAddress(is.idega.idegaweb.egov.fsk.banking.ws.common.Address claimantAddress) {
        this.claimantAddress = claimantAddress;
    }
     ...
     * should not be used.
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.common.Address getPayorAddress() {
        return payorAddress;
    }
     ...
     * should not be used.
     */
    public void setPayorAddress(is.idega.idegaweb.egov.fsk.banking.ws.common.Address payorAddress) {
        this.payorAddress = payorAddress;
    }
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow[] getItemRows() {
        return itemRows;
    }
     ...
     */
    public void setItemRows(is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow[] itemRows) {
        this.itemRows = itemRows;
    }

    public is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow getItemRows(int i) {
        return this.itemRows[i];
    }

    public void setItemRows(int i, is.idega.idegaweb.egov.fsk.banking.ws.claims.ItemRow _value) {
