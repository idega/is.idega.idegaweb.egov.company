...
public class Communication  implements java.io.Serializable {
    /* Postal mail */
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationPostalMail postalMail;

    /* Email */
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail[] EMail;

    /* SMS message (Short Message Service, a service for sending messages
     * to GSM mobilephones) */
    private is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS[] SMS;

    public Communication() {
    }

    public Communication(
           is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationPostalMail postalMail,
           is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail[] EMail,
           is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS[] SMS) {
     ...
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationPostalMail getPostalMail() {
        return postalMail;
    }
     ...
     */
    public void setPostalMail(is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationPostalMail postalMail) {
        this.postalMail = postalMail;
    }
     ...
     * @return EMail   * Email
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail[] getEMail() {
        return EMail;
    }
     ...
     * @param EMail   * Email
     */
    public void setEMail(is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail[] EMail) {
        this.EMail = EMail;
    }

    public is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail getEMail(int i) {
        return this.EMail[i];
    }

    public void setEMail(int i, is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationEMail _value) {
        this.EMail[i] = _value;
    }
     ...
     * to GSM mobilephones)
     */
    public is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS[] getSMS() {
        return SMS;
    }
     ...
     * to GSM mobilephones)
     */
    public void setSMS(is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS[] SMS) {
        this.SMS = SMS;
    }

    public is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS getSMS(int i) {
        return this.SMS[i];
    }

    public void setSMS(int i, is.idega.idegaweb.egov.fsk.banking.ws.payments.CommunicationSMS _value) {
        this.SMS[i] = _value;
    }
