...
public class IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub extends org.apache.axis.client.Stub implements is.idega.idegaweb.egov.fsk.banking.ws.secondary.client.IcelandicOnlineBankingSecondaryCollectionClaimsSoap {
    ...
    public IcelandicOnlineBankingSecondaryCollectionClaimsSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.egov.fsk.banking.ws.claims.SecondaryCollectionClaimsQuery.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.egov.fsk.banking.ws.claims.SecondaryCollectionPaymentsQuery.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
